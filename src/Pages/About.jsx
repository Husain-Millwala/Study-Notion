...
import Quoto from "../Components/COre/About/Qouto";
import Stats from "../Components/COre/About/State";
    ...
    <>
      <section className=" bg-richblack-700">
        <div className=" relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header>
            <h1 className=" mx-auto py-20 text-4xl font-bold lg:w-[70%]">
          ...
          <div className=" absolute bottom-8 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
